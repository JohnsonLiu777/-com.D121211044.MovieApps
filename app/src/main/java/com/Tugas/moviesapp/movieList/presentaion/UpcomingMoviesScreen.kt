...
import com.Tugas.moviesapp.movieList.presentaion.components.MovieItem
import com.Tugas.moviesapp.movieList.util.Category

@Composable
fun UpcomingMoviesScren(
    ...
    if(movieListState.upcomingMovieList.isEmpty()){
        ...
        LazyVerticalGrid(
            ...
            items(movieListState.upcomingMovieList.size){index ->
                MovieItem(
                    movie = movieListState.upcomingMovieList[index], navHostController =navController
                )
